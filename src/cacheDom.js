function cacheDom() {
    ...
    return {tasksBtn, todayBtn, weekBtn, projectWrapper, projectBtn, dropDownArrow, projectList, tasksContainer, activeTasksContainer, newTaskBtn, modalContainer, modalCloseBtn, form, titleInput, descInput, dateInput, priorityInput, projectInput, submitBtn, taskCloseBtn}
};
